...
<p>
  <img src="https://img.shields.io/badge/version-v0.5.0_release-0A84FF?style=flat-square" alt="Version v0.5.0 release">
  <img src="https://img.shields.io/badge/v0.5.0-latest-5856D6?style=flat-square" alt="V0.5.0 latest">
...
- 最新发布版本：[`v0.5.0`](https://github.com/oneszc/SkillDock/releases/tag/v0.5.0)
- 自动化测试：140 项通过
- 当前发布版本：V0.5.0，新增 DeepSeek 单 Skill 中文译文
- V0.5 已通过产品负责人真实 API、视觉和交互验收
