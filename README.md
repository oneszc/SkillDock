...
<p>
  <img src="https://img.shields.io/badge/version-v0.4.1_release-0A84FF?style=flat-square" alt="Version v0.4.1 release">
  <img src="https://img.shields.io/badge/v0.4.1-latest-5856D6?style=flat-square" alt="V0.4.1 latest">
...
- 最新发布版本：[`v0.4.1`](https://github.com/oneszc/SkillDock/releases/tag/v0.4.1)
- 自动化测试：116 项通过
- 当前发布版本：V0.4.1，包含多 Agent 展示与 GitHub Skill 更新检查修复
- 下一阶段：V0.5 AI 中文译文已完成方案规划，尚未进入功能发布
