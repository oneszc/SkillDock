...
test -f "$APPEARANCE_RESOURCES/codex.svg"
test -f "$APPEARANCE_RESOURCES/claude.svg"
test -f "$APPEARANCE_RESOURCES/codex-gray.svg"
test -f "$APPEARANCE_RESOURCES/claude-gray.svg"
plutil -lint "$PLIST"
