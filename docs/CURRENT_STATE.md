...
V0.3.1 Agent 安装状态与安全卸载管理已完成并发布 GitHub Release。

## Current Goal

进入 V0.3.2，实现手动更新检查、文件变化预览、安全替换确认和 Agent 筛选。
...
- V0.3.1 发布 Agent 安装状态与安全卸载；手动更新检查和 Agent 筛选顺延到 V0.3.2。
...
- V0.3.1 Agent 安装管理和 Logo 视觉修复已发布。
- 最新发布版本：`v0.3.1`。
- 下一步开始 V0.3.2 手动更新检查、变化预览与 Agent 筛选。
