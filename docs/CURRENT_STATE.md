...
下一次继续体验 V0.2.1 的整体观感。设置入口已改为苹果菜单旁的 SkillDock → Settings…（⌘,）独立设置窗口；左侧保留可扩展分类导航，红绿灯位于浮层侧栏。确认其余视觉是否还需微调。
...
- 已生成并独立解压验证本地测试安装包 `dist/SkillDock-0.2.1.zip`；当前仍为临时本地签名，尚未发布 GitHub Release。
- 自动化测试共 44 项，全部通过。
...
- 本地 V0.2.1 测试安装包 SHA-256：`f5bebc57473fc866899e1b2cf4af9e89547bce317bd25d955612018bb85b67be`。
