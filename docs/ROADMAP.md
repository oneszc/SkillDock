...
V0.3.3 已完成并发布 GitHub Release。V0.4.0 已完成、验收并发布；V0.4.1 维护更新已发布。V0.5.0 已完成开发、产品验收并发布 GitHub Release。
...
状态：功能开发、自动化验证和产品负责人手动验收均已完成，V0.5.0 已发布 GitHub Release。
...
状态：代码开发、完整测试和打包验证已完成，待产品负责人验收与 GitHub Release；实施计划见 `docs/superpowers/plans/2026-06-29-v0.5.1-system-classification-and-plugin-import-notice.md`。
